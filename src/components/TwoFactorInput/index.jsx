      ...
      <div className="w-full mobTwoFactor">
        {code.map((_, index) => (
          <Input
            ...
            className="w-[42px] flex-1 h-[50px] outline-none text-primary10 font-semibold text-[36px] text-center"
            pattern="[0-9]"
            value={code[index]}
      ...
      <div className="flex gap-2 w-full">
        {code.map((_, index) => (
          <Input
            ...
            inputMode="numeric"
            styleDiv={{ backgroundColor: "#272C33" }}
            className="w-[46px] flex-1 h-[60px] outline-none text-primary10 font-semibold text-[36px] text-center"
            pattern="[0-9]"
            value={code[index]}
            onChange={(e) => handleChange(index, e)}
            onKeyDown={(e) => handleKeyDown(index, e)}

...
import Forget2FA from "../components/forget/forget";
...
function Forget({isMobile,goToLogin}) {
  ...
  if(step === 1){
    return <Forget1 isMobile={isMobile} email={email} setEmail={setEmail} setStep={setStep} />;
  }
  if(step === 2){
    return <Forget2FA isMobile={isMobile} code={code} setCode={setCode} onApply={handleApplyCode}/>;
  }
  if(step === 3) {
